    ...
    <div className="minimal-card p-8 max-w-2xl mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-minimal-text-light clean-font">
          This will open your email client with a pre-filled message ready to
          send!
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="space-y-2">
            <label
              htmlFor="name"
              className="block text-sm font-medium text-minimal-text clean-font"
            >
        ...
        <div className="space-y-4">
          ...
          {submitStatus === "success" && (
            <div className="flex items-center justify-center space-x-2 text-green-600 bg-green-50 p-3 rounded-lg">
              ...
              <span className="clean-font">
                Email client opened! Please click 'Send' in your email app to
                complete.
              </span>
            </div>
          )}
          ...
          {submitStatus === "error" && (
            <div className="flex items-center justify-center space-x-2 text-red-600 bg-red-50 p-3 rounded-lg">
              ...
              <span className="clean-font">
                Unable to open email client. Please email me directly.
              </span>
            </div>
          )}
        </div>
